...
public class MoarCubeCustomBlockComplex extends GenericCubeCustomBlock {
	private int miny = 0, maxy = 126, frequency = 0,maxDump=0;

	public MoarCubeCustomBlockComplex(MoarStuph p, String name, int id) {
		super(p, name, new GenericCubeBlockDesign(p, p.OreTextureFile, id));
	}
	public MoarCubeCustomBlockComplex(MoarStuph p, String name, GenericCubeBlockDesign b,int miny,int maxy,int fr, int maxD) {
		super(p, name, b);
		this.miny = miny;
		this.maxy = maxy;
		this.frequency = fr;
