...
public class MoarCubeCustomBlockSimple extends GenericCubeCustomBlock {
	private int miny = 0, maxy = 126, frequency = 0,maxDump=0;

	public MoarCubeCustomBlockSimple(MoarStuph p, String name, int id) {
		super(p, name, new GenericCubeBlockDesign(p, p.OreTextureFile, id));
	}
	public MoarCubeCustomBlockSimple(MoarStuph p, String name, int id,int miny,int maxy,int fr, int maxD) {
		super(p, name, new GenericCubeBlockDesign(p, p.OreTextureFile, id));
		this.miny = miny;
		this.maxy = maxy;
		this.frequency = fr;
